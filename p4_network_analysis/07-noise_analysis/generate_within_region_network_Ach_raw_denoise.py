...
# logger
log_file_name = 'region-network-ach-noise-both'
...
region_selected_list = [66,55]
data_index = '20230510-fly2' # 20230420_fly2
logger.info('============ data_index ' + data_index + ' noise ===========')
...
## path
path = '/sam2p/0-FJQ/olfactory_representation/data/' + date_id + '-nsyb-G7f-rAch1h/' + fly_id + '/data_nodenoise/'
path_atlas  = '/sam2p/0-FJQ/olfactory_representation/data/' + date_id + '-nsyb-G7f-rAch1h/' + fly_id + '/align_to_atlas/'
path_output = '/sam2p/0-LLB/olfactory_representation/Ach-' + data_index + '-noise-trans-stimu/'

## generate network for each region
for region_idx in region_selected_list:   
...
logger.info('============ data_index ' + data_index + ' denoise ===========')
