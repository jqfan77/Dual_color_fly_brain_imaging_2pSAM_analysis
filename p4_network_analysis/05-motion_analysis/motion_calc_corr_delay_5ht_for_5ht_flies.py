...
for data_index in data_index_list: 
    ...
    path_output = path_inspur + data_index + '-trans-pre_stimu/'
    ...
    k = 10
    motion_strength_down = np.load(path_inspur + "motion_res/motion_strength_down_404_up10_" + data_index + ".npy")
    ...
    caxes = axes.matshow(regions_corr, interpolation ='nearest', cmap = "Blues", aspect = 'auto') 
    plt.yticks([])
