...
# logger
log_file_name = 'motion-corr-g7f-5ht'
...
for data_index in data_index_list: 
    ...
    path_output = path_inspur + data_index + '-pre_stimu/'
    ...
    caxes = axes.matshow(regions_corr, interpolation ='nearest', cmap = "Greens", aspect = 'auto') 
    plt.yticks([])
