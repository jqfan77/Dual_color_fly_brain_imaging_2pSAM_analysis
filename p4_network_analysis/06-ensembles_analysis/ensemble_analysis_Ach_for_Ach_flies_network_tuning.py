...
# logger
log_file_name = 'ensemble-network-ach-tuning'
...
for data_index in data_index_list: 
    ...
    #     records_sample = np.load(path_output +'neuron_concat_records/sample_neuron_records_tuning_odor_' + str(odor + 1) + '.npy',allow_pickle=True)
    #     logger.info("records_sample: {}, {}".format(type(records_sample), records_sample.shape))
    ...
    #     np.save(path_output + 'network/sample_neuron_similarity_odor' + str(odor) + '_tuning.npy', similarity)
    #     logger.info("Successfully saving similarity matrix!")
    ...
    #     caxes = axes.matshow(similarity, interpolation ='nearest') 
    #     figure.colorbar(caxes) 
    #     plt.savefig(path_output + 'network/sample_neuron_similarity_odor' + str(odor) + '_tuning.png',  dpi = 300, bbox_inches='tight')
    #     plt.show()
    ...
    #     df.to_csv(path_output + 'network/sample_neuron_similarity_odor' + str(odor) + '_network_tuning.csv', index=False)
