...
# logger
log_file_name = 'concate-stimu-5ht-for-5ht-flies'
...
for data_index in data_index_list: 
    ...
    path_output = '/sam2p/0-LLB/olfactory_representation/' + date_id + '-r5HT1.0-' + fly_id + '-trans-stimu/'
    logger.info(path)
    ...
    dff0_con_C3 = np.load(path + 'dff0_-6-40_down2_C3.npy') 
