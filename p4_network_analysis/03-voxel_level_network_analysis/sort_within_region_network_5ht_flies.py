...
# logger
log_file_name = 'region-network-5ht-flies-sort'
...
path_res = '/as13000_sam2p/0-LLB/olfactory_representation/single_region_res/'
...
for data_index in data_index_list: 
    ...
    for region_idx in [66,55,64,65,73,63,84,59,23,26,85,79,77]:   
        ...
        ## plot 5ht correlation matrix
        path_output = '/as13000_sam2p/0-LLB/olfactory_representation/' + date_id + '-r5HT1.0-' + fly_id + '-trans-stimu/'
        logger.info("path_output:{}".format(path_output))
