...
# logger
log_file_name = 'brain-network-g7f-for-5ht-flies-RS'
...
for data_index in data_index_list: 
    ...
    path_output = '/sam2p/0-LLB/olfactory_representation/' + date_id + '-r5HT1.0-' + fly_id + '-pre_stimu/'
    ...
    for region_idx in focus_regions:
        ...
        select_data = records[:, 4 : length - 4]
