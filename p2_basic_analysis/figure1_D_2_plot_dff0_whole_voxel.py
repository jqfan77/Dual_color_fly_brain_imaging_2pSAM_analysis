##
## plot the dff0 of the whole voxel traces in selected points
##
...
for root, dirs, files in os.walk(result_path + flyname + '/data/region_voxel_trace'):
    for f in files:
        if 'single_voxel' in f and 'C2' in f and 'dff0' in f:
        ...
        if 'single_voxel' in f and 'C3' in f and 'dff0' in f:
